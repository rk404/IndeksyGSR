...
async def extract_allegro(page) -> dict:
    result: dict = {}
    await bypass_antibot_protection(page)
...
def is_antibot_protected(html) -> bool:
    return "DataDome CAPTCHA" in html or "DataDome Device Check" in html or "You have been blocked" in html
